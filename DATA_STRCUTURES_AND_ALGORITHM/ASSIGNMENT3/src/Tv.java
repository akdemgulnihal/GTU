public class Tv implements Device
{
     ...
     * 
     * @param name  This parameter is the name of the tv
     * @param price This parameter is the price of the tv
     * @param quantity  This parameter is the quantity of the tv
     */
